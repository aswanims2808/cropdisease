...
// Signature "flux" palette — a vivid green → yellow fill (Updated for AGRIXA).
const FLUX_FROM = "var(--flux-from, #27AE60)";
const FLUX_TO = "var(--flux-to, #F1C40F)";
...
// and a deep-green inset for depth.
const BAR_SHADOW = `0 0 18px color-mix(in oklab, ${FLUX_FROM} 55%, transparent), 0 0 32px color-mix(in oklab, ${FLUX_TO} 40%, transparent), inset 0 1.5px 0 rgba(255, 255, 255, 0.5), inset 0 -2px 3px rgba(0, 80, 40, 0.35)`;
